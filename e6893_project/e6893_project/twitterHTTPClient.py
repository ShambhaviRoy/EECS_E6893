...
ACCESS_TOKEN = '1448114693042810887-U1jCDPzYdETHDDEOzWu242mfcaj9aA'     # your access token
ACCESS_SECRET = 'n7s7nkUe6yjuUdLWw0xoVDgWAJkOBuj3mPHrskA0dmPl4'    # your access token secret
CONSUMER_KEY = 'AYvwzyzAPvCTVsXNloCaXYXk2'     # your API key
CONSUMER_SECRET = 'iJUrV2rnxryD0XNXk2lQiWzzzFjIcpLSX9PktuH6D2RJ4fLJHh'  # your API secret key
...
if __name__ == '__main__':
    client = twitter_client("localhost", 9002)
